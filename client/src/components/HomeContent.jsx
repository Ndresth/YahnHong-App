...
export default function HomeContent({ onSelectProduct }) {
  ...
  const handleAdd = (e, product) => {
    e.stopPropagation(); // Evita abrir el modal si se hace click en el botón
    addToCart(product, 1, product.precio, product.tamaño || 'Personal');
            ...
            <div key={product.id} className="col-6 col-md-4 col-lg-3">
              ...
              >
                ...
                <div className="p-3 d-flex flex-column flex-grow-1">
                  <h6 className="fw-bold mb-1 text-truncate">{product.nombre}</h6>
