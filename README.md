...
- **Categorías solo POS:** `categoriasSoloPos` en `shared/config.json` (hoy: **Combos** — Combo $14.000, Combo con Carne $15.000 — y **Cajas** — Caja C1 $500, Caja J1 $1.000). Se venden en el POS pero no salen en el menú web ni se pueden pedir desde la web.
